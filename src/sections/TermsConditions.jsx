...
const TermsConditions = () => {
  return (
    <section className="landing-section py-24 relative overflow-hidden bg-gradient-to-br from-slate-50 via-white to-slate-50">
      <div className="container mx-auto px-5 relative z-10">
        ...
        <div className="mt-16 max-w-4xl mx-auto">
          <div className="bg-white/90 backdrop-blur-md rounded-3xl p-12 shadow-xl border border-gray-100">
            
            {/* Informations de contact */}
            <div className="mb-12 p-6 bg-gradient-to-r from-[#d9b8b0]/10 to-[#e7d3cb]/10 rounded-2xl border border-[#d9b8b0]/20">
            ...
            <div className="mt-8 p-6 bg-gradient-to-r from-[#d9b8b0]/10 to-[#e7d3cb]/10 rounded-2xl border border-[#d9b8b0]/20">
